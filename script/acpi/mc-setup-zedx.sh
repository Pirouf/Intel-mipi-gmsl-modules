...
#   INTC10C0 = AR0234 camera (entity prefix:   "ar0234")
...
# ---- AR0234 (ST, RAW10 Bayer) ----------------------------------------------
# Streams: raw
AR0234_FMT=${AR0234_FMT:-SGRBG10_1X10}
AR0234_SIZE=${AR0234_SIZE:-1280x960}

# Stream metadata.  d4xx: depth/rgb/ir/imu.  isx031: yuv.  ar0234: raw.
