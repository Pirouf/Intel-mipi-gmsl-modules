...
#ifndef DESCH_RESET_GPIO_PIN2
#ifndef DESCH_RESET_GPIO_PIN
...
#ifdef DESCH_RESET_GPIO_PIN

#if DESCH_RESET_GPIO_PIN2 == DESCH_RESET_GPIO_PIN
#error "DESCH_RESET_GPIO_PIN2 and DESCH_RESET_GPIO_PIN cannot be the same GPIO pin number"
#endif
